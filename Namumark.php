                    ...
                    if (preg_match('/^([^=]*)=([^=]*)$/', $attr, $tbattr)) {
                        ...
                        if (
                            ...
                            && (
                                ...
                                || (in_array($tbattr[1], ['tablebgcolor', 'table bgcolor', 'tablecolor', 'table color', 'tablebordercolor', 'table bordercolor']) && self::chkColor($tbattr[2]))
                            )
                        ) {
                            // 표 속성
                            $i += strlen($tbattr[0]) + 2;
